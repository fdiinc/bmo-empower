 ...
 */
public class SearchClearEvent implements ApplicationEvent {

  private String formInput;

  /**
   * Constructs a search results clear event.
   * @param fields the search fields used in the search
   */
  public SearchClearEvent(String formInput) {
    super();
